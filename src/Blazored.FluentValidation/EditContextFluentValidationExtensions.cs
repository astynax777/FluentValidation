...
public static class EditContextFluentValidationExtensions
{
    ...
    private sealed class FluentValidationEventSubscriptions : IDisposable
    {
        ...
        {
            var validator = _validator ?? GetValidatorForModel(_serviceProvider, _editContext.Model, _disableAssemblyScanning);
        ...
        private async Task ValidateField(object? sender, FieldChangedEventArgs e)
        {
            ...
            var validator = _validator ?? GetValidatorForModel(_serviceProvider, e.FieldIdentifier.Model, _disableAssemblyScanning);
